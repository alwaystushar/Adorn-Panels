...
<div className="grid-container">
  ...
  <div className="col-span-12 md:col-span-7 flex">
    <img src="img/adorn-panal.svg" className="w-full" alt="Adorn Panels"/>
  </div>

  {/* Text Column - 4 columns starting at column 9 */}
  <div className="col-span-12 md:col-span-4 md:col-start-9 flex flex-col gap-[2.5vw]">

    <div className="flex flex-col gap-[1.5vw]">
    <TextReveal 
      className="h4 font-semibold text-(--color-grey)"
      triggerOnScroll={false}
      delay={0.8}
      duration={1.4}
      stagger={0.15}
    >
      Transform your space with Adorn Panels
    </TextReveal>
    ...
    <TextReveal 
      ...
      stagger={0.15}
    >
      Over 75+ varieties of wall panels - acoustic, decorative, and outdoor solutions.
    </TextReveal>        
    </div>
<div>
            <ExplorePanelsButton variant="dark" href="/panels">
              Explore Panels
            </ExplorePanelsButton>
</div>
